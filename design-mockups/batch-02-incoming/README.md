# Batch 02 — incoming (drop zone)

Drop the next batch of mockup `*.html` bundles **here**.
...
4. Implement Tier 1 → Tier 2 → Tier 3; open a PR per fix; keep `STATUS.md` current.

Rename this folder (e.g. `batch-02-<theme>/`) once you know what the batch covers.
