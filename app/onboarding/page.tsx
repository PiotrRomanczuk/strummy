...
export default async function OnboardingPage() {
  ...
  // v2 is the default; any non-v3 cookie value (including legacy 'v1') falls
  // through here. The retired v1 form was removed because it skipped the role
  // selection step and silently defaulted every user to "student".
  return (
