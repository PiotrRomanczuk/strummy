...
jest.mock('@/app/api/(curriculum)/lessons/utils', () => {
  const actual = jest.requireActual('@/app/api/(curriculum)/lessons/utils');
  return {
    ...actual,
...
import { createLessonHandler } from '@/app/api/(curriculum)/lessons/handlers';
