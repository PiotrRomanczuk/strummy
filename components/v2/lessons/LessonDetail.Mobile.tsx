...
import { Play, Pencil, Trash2, MoreHorizontal, Calendar, User, Music, FileText, Hash, ClipboardList } from 'lucide-react';
...
export function LessonDetailMobile({
  lesson,
  canEdit,
  canDelete,
  onDelete,
  ...
  return (
    ...
    >
      ...
      <div className="space-y-3">
        ...
        <Link href={`/dashboard/users/${lesson.student_id}`}>
          <InfoRow
            icon={User}
            label="Student"
        ...
        <Link href={`/dashboard/users/${lesson.teacher_id}`}>
          <InfoRow
            icon={User}
            label="Teacher"
            value={
        ...
        <BottomActionSheet
          ...
          actions={[
            ...
            },
            {
              ...
              onClick: () => router.push(`/dashboard/assignments/new?lesson_id=${lesson.id}&student_id=${lesson.student_id}`),
            },
            ...(canDelete
              ? [
                  {
