...
export const TemplatesList = async ({ templates }: Props) => {
              ...
              >
                ...
                {template.checklist.length > 0 && (
                  ...
                  >
                    ...
                    {template.checklist.length === 1
                      ? t('templatesListChecklistCountSingular')
                      : t('templatesListChecklistCountPlural')}
                  </div>
                )}
              </Link>
            ))}
