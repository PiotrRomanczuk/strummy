/**
 * Shell tests for SongDetail — the page-level component behind
 * /dashboard/songs/[id]. SongHero has its own dedicated test
 * (SongHero.test.tsx) covering the full "Edit song" link render
