...
| --------------------------------------- | ----------------------------------- | ----------------- | ------- |
| Users table row (name/avatar/email)     | `UsersList.tsx:185`        | /users/[id]       | ✅      |
| Lesson detail "with …"                  | `LessonDetail.tsx:175`     | /users/[id]       | ✅      |
| Assignment detail "for …"               | `AssignmentDetail.tsx:144` | /users/[id]       | ✅      |
...
| Lessons table · student column          | `LessonsList.tsx:299`      | /lessons/[id]     | 🟡      |
| Assignments table · student column      | `AssignmentsList.tsx:195`  | /assignments/[id] | 🟡      |
| Teacher "today" schedule · student      | `TeacherDaySpineLesson.tsx:54`      | /lessons/[id]     | 🟡      |
| Student dash · next-lesson teacher      | `StudentDashboard.tsx:158` | /lessons/[id]     | 🟡      |
| Users table · "Edit →"                  | `UsersList.tsx:263`        | /users/[id]/edit  | 🟡      |
| Student Health · "View Profile" (bug)   | `StudentHealthTable.tsx:222`        | /users?id= ⚠      | 🟡      |
| Admin · Locked accounts name            | `LockedAccountsCard.tsx:76`         | —                 | ❌      |
| Student dash · "with {teacher}"         | `StudentDashboard.tsx:115` | —                 | ❌      |
...
| Admin dash · pending invite email       | `AdminDashboard.tsx:155`   | —                 | ❌      |
...
| Location                            | File · line                           | Goes to           | Verdict |
| ----------------------------------- | ------------------------------------- | ----------------- | ------- |
| Lessons list rows                   | `LessonsList.tsx:270`        | /lessons/[id]     | ✅      |
| Teacher "today's schedule"          | `TeacherDaySpineLesson.tsx:28`        | /lessons/[id]     | ✅      |
| Student dash · Next lesson card     | `StudentDashboard.tsx:130`   | /lessons/[id]     | ✅      |
| Student detail · Recent lessons     | `StudentDetail.tsx:278`      | /lessons/[id]     | ✅      |
| Assignment detail · lesson link     | `AssignmentDetail.tsx:186`   | /lessons/[id]     | ✅      |
...
| Notifications inbox rows            | `Notifications.List.tsx:124` | —                 | ❌      |
| Calendar · conflict card            | `ConflictList.tsx:84`                 | —                 | ❌      |
| Student dash · greeting text        | `StudentDashboard.tsx:109`   | —                 | ❌      |
...
| Location                           | File · line                                | Goes to       | Verdict |
| ---------------------------------- | ------------------------------------------ | ------------- | ------- |
| Song library table                 | `SongsList.tsx:34`                | /songs/[id]   | ✅      |
| Song detail · related songs        | `SongSidebar.tsx:137`             | /songs/[id]   | ✅      |
| Lesson detail · songs in lesson    | `LessonDetail.tsx:214`            | /songs/[id]   | ✅      |
| Assignment detail · song           | `AssignmentDetail.tsx:175`        | /songs/[id]   | ✅      |
| Student detail · repertoire        | `StudentDetail.Repertoire.tsx:26` | /songs/[id]   | ✅      |
| Student dash · working on          | `StudentDashboard.tsx:174`        | /songs/[id]   | ✅      |
...
| Notifications inbox rows (mastery) | `Notifications.List.tsx:156`      | —             | ❌      |
...
| **P1**       | Make notifications actionable: consume `action_url` in the inbox; emit `/[id]` deep links in the content builders                                                                | `Notifications.List.tsx`, `notification-in-app-content.ts`         | Medium |
...
| **P1**       | Make student/teacher names in list rows individually clickable (sibling link + `stopPropagation`); surface + link the teacher on lesson detail                                   | `LessonsList`, `AssignmentsList`, `LessonDetail` | Medium |
